/*
Analysis Project: Analyzing Sales Data to Improve Sales Performance
...
SELECT 
    ...
    ROUND(
        ...
        2
    ) AS revenue_per_order_perc_change,
    profit_per_order,
    ...
    ROUND(
        ...
        2
    ) AS profit_per_order_perc_change
FROM profit_data
ORDER BY 
    country, months;
